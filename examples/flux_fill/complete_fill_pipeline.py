...
#     latent_image_ids = backend.zeros(height, width, 3)
#     latent_image_ids[..., 1] = latent_image_ids[..., 1] + backend.arange(height)[:, None]
#     latent_image_ids[..., 2] = latent_image_ids[..., 2] + backend.arange(width)[None, :]
